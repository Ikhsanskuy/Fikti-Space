                      ...
                      <table class="table table-bordered text-center">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><div style="width: max-content;"><a href="../../data_user/<?=$official_krs?>" target="__blank"><?=$official_krs?></a></div></td>
                            <th>
                              <?php 
                      ...
                      <table class="table table-bordered table-striped text-center">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><div style="width: max-content;"><a href="../../data_user/<?=$member1_krs?>" target="__blank"><?=$member1_krs?></a></div></td>
                            <th>
                              <?php 
                          ...
                          <tr>
                            ...
                            <td><div style="width: max-content;"><a href="../../data_user/<?=$member2_krs?>" target="__blank"><?=$member2_krs?></a></div></td>
                            <th>
                              <?php 
                          ...
                          <tr>
                            ...
                            <td><div style="width: max-content;"><a href="../../data_user/<?=$member3_krs?>" target="__blank"><?=$member3_krs?></a></div></td>
                            <th>
                              <?php 
                          ...
                          <tr>
                            ...
                            <td><div style="width: max-content;"><a href="../../data_user/<?=$member4_krs?>" target="__blank"><?=$member4_krs?></a></div></td>
                            <th>
                              <?php 
                          ...
                          <tr>
                            ...
                            <td><div style="width: max-content;"><a href="../../data_user/<?=$member5_krs?>" target="__blank"><?=$member5_krs?></a></div></td>
                            <th>
                              <?php 
                          ...
                          <tr>
                            ...
                            <td><div style="width: max-content;"><a href="../../data_user/<?=$member6_krs?>" target="__blank"><?=$member6_krs?></a></div></td>
                            <th>
                              <?php 
