...
<div class="row">
    ...
    <div class="col-12 col-lg-6 col-md-6">
        <form action="" method="post" enctype="multipart/form-data" class="bg-white px-5 my-4 py-4" style="border-radius: 5px;">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="nama_lengkap" value="<?=$official_nama_lengkap?>">
            </div>
            <div class="form-group">
    ...
    <div class="col-12 col-lg-6 col-md-6">
        <form action="" method="post" enctype="multipart/form-data" class="bg-white px-5 my-4 py-4" style="border-radius: 5px;">
            ...
            <div class="form-group">
                <h6 class="mb-2">Nama Lengkap</h6>
                <input type="text" class="form-control" name="nama_lengkap" value="<?=$member1_nama_lengkap?>">
            </div>
            <div class="form-group">
                <h6 class="mb-2">Instansi</h6>
    ...
    <div class="col-12 col-lg-6 col-md-6">
        <form action="" method="post" enctype="multipart/form-data" class="bg-white px-5 my-4 py-4" style="border-radius: 5px;">
            ...
            <div class="form-group">
                <h6 class="mb-2">Nama Lengkap</h6>
                <input type="text" class="form-control" name="nama_lengkap" value="<?=$member2_nama_lengkap?>">
            </div>
            <div class="form-group">
                <h6 class="mb-2">Instansi</h6>
    ...
    <div class="col-12 col-lg-6 col-md-6">
        <form action="" method="post" enctype="multipart/form-data" class="bg-white px-5 my-4 py-4" style="border-radius: 5px;">
            ...
            <div class="form-group">
                <h6 class="mb-2">Nama Lengkap</h6>
                <input type="text" class="form-control" name="nama_lengkap" value="<?=$member3_nama_lengkap?>">
            </div>
            <div class="form-group">
                <h6 class="mb-2">Instansi</h6>
    ...
    <div class="col-12 col-lg-6 col-md-6">
        <form action="" method="post" enctype="multipart/form-data" class="bg-white px-5 my-4 py-4" style="border-radius: 5px;">
            ...
            <div class="form-group">
                <h6 class="mb-2">Nama Lengkap</h6>
                <input type="text" class="form-control" name="nama_lengkap" value="<?=$member4_nama_lengkap?>">
            </div>
            <div class="form-group">
                <h6 class="mb-2">Instansi</h6>
    ...
    <div class="col-12 col-lg-6 col-md-6">
        <form action="" method="post" enctype="multipart/form-data" class="bg-white px-5 my-4 py-4" style="border-radius: 5px;">
            ...
            <div class="form-group">
                <h6 class="mb-2">Nama Lengkap</h6>
                <input type="text" class="form-control" name="nama_lengkap" value="<?=$member5_nama_lengkap?>">
            </div>
            <div class="form-group">
                <h6 class="mb-2">Instansi</h6>
    ...
    <div class="col-12 col-lg-6 col-md-6">
        <form action="" method="post" enctype="multipart/form-data" class="bg-white px-5 my-4 py-4" style="border-radius: 5px;">
            ...
            <div class="form-group">
                <h6 class="mb-2">Nama Lengkap</h6>
                <input type="text" class="form-control" name="nama_lengkap" value="<?=$member6_nama_lengkap?>">
            </div>
            <div class="form-group">
                <h6 class="mb-2">Instansi</h6>
