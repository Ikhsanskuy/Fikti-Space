...
<div class="row">
    ...
    if($payment != ''){
        echo"<div class='col-12 col-lg-4 col-md-4'>
                <div class='px-3 my-4 py-4' style='border-radius: 5px; border: 2px solid black;'>
                    <h4>Pembayaran telah dilakukan !</h4><br>
                    <p>Jika dalam 1x24 jam status pembayaran belum berubah, dapat menghubungi contact person kami</p>
                    <br>
                    <p>whatsapp : <b>Zulkifli(0888999222)</b></p>
                    <p>line : <b>Zulkifli(zulkifli_oyoy)</b></p>
                </div>
            </div>";
