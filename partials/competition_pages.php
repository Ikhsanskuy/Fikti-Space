                ...
                <div class="col-12 col-lg-10 col-md-10 order-lg-1 order-md-1 order-2 px-5">
                    ...
                    <div class="row">
                        ...
                        while($rule < count($comp_rules)){
                            echo "<div class='col-1 text-center'><h5 class='text-white'>&bull;</h5></div>
                                  <div class='col-11'>$comp_rules[$rule]</div>";
                            $rule++;
                        }?>

                    <br><br>
                    <div class="col-1 text-center"><h5 class="text-white"></h5></div>
                    <div class='col-11'><a href="../guide-book/GD-<?=$competition_slug?>.pdf" target="__blank"><button class="btn btn-small btn-outline-success px-4 py-2">See more</button></a></div>
                    </div>
                    <br><br>

                    <h5 class="text-white py-0">Contact Person</h5>
                    <i class="fa-brands fa-line"></i> (Lorem ipsum dolor)<br>
                    <i class="fa-brands fa-whatsapp"></i> (Lorem ipsum)<br>
                </div>
